...
int num=0, speed=3;
int x[SPRITE_MAX], y[SPRITE_MAX], vx[SPRITE_MAX], vy[SPRITE_MAX];
int last_time = 0;
BITMAP_OBJECT *bmp;
...
void in_loop(void) {
	...
	textout(canvas(), font(), str, 20, 20, 24, makecol(255,255,255,255), 0, 0);
...
int main(void) {
	enable_debug("output");
	allegro_init_all("canvas", 640, 480, 1, NULL);
